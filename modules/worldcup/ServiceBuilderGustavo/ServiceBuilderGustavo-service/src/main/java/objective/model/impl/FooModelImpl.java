...
import objective.model.FooModel;
import objective.model.FooSoap;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(objective.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.objective.model.Foo"), true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(objective.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.objective.model.Foo"), true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(objective.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.objective.model.Foo"), true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(objective.service.util.ServiceProps.get(
				"lock.expiration.time.objective.model.Foo"));
