 ...
 * {@link objective.service.impl.FooLocalServiceImpl} and is the
 ...
 * @see FooLocalService
 * @see objective.service.base.FooLocalServiceBaseImpl
 * @see objective.service.impl.FooLocalServiceImpl
 * @generated
 */
@ProviderType
public class FooLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link objective.service.impl.FooLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<objective.model.Foo> getFoos(int start, int end) {
	...
	*/
	public static java.util.List<objective.model.Foo> getFoosByUuidAndCompanyId(
	...
	*/
	public static java.util.List<objective.model.Foo> getFoosByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<objective.model.Foo> orderByComparator) {
		return getService()
	...
	*/
	public static objective.model.Foo addFoo(objective.model.Foo foo) {
	...
	* @return the new foo
	*/
	public static objective.model.Foo createFoo(long fooId) {
	...
	*/
	public static objective.model.Foo deleteFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	* @return the foo that was removed
	*/
	public static objective.model.Foo deleteFoo(objective.model.Foo foo) {
		return getService().deleteFoo(foo);
	}

	public static objective.model.Foo fetchFoo(long fooId) {
	...
	*/
	public static objective.model.Foo fetchFooByUuidAndGroupId(
	...
	* @throws PortalException if a foo with the primary key could not be found
	*/
	public static objective.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static objective.model.Foo getFooByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static objective.model.Foo updateFoo(objective.model.Foo foo) {
