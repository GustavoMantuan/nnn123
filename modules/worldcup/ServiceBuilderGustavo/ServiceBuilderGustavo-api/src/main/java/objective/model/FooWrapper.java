...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<objective.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public int compareTo(objective.model.Foo foo) {
	...
	*/
	...
	@Override
	public objective.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public objective.model.Foo toUnescapedModel() {
