 ...
 * @see FooModel
 * @see objective.model.impl.FooImpl
 * @see objective.model.impl.FooModelImpl
 * @generated
 */
@ImplementationClassName("objective.model.impl.FooImpl")
@ProviderType
public interface Foo extends FooModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link objective.model.impl.FooImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
