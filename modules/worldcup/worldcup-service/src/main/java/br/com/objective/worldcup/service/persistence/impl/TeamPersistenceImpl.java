...
package br.com.objective.worldcup.service.persistence.impl;

import aQute.bnd.annotation.ProviderType;

import br.com.objective.worldcup.exception.NoSuchTeamException;
import br.com.objective.worldcup.model.Team;
import br.com.objective.worldcup.model.impl.TeamImpl;
 ...
 * @see TeamPersistence
 * @see br.com.objective.worldcup.service.persistence.TeamUtil
 * @generated
 */
@ProviderType
public class TeamPersistenceImpl extends BasePersistenceImpl<Team>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_NAME = new FinderPath(TeamModelImpl.ENTITY_CACHE_ENABLED,
			TeamModelImpl.FINDER_CACHE_ENABLED, TeamImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_NAME = new FinderPath(TeamModelImpl.ENTITY_CACHE_ENABLED,
			TeamModelImpl.FINDER_CACHE_ENABLED, TeamImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByName",
			new String[] { String.class.getName() },
			TeamModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_NAME = new FinderPath(TeamModelImpl.ENTITY_CACHE_ENABLED,
			TeamModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public Team findByName_First(String name,
		OrderByComparator<Team> orderByComparator) throws NoSuchTeamException {
	 ...
	 */
	@Override
	public Team fetchByName_First(String name,
		OrderByComparator<Team> orderByComparator) {
	 ...
	 */
	@Override
	public Team findByName_Last(String name,
		OrderByComparator<Team> orderByComparator) throws NoSuchTeamException {
	 ...
	 */
	@Override
	public Team fetchByName_Last(String name,
		OrderByComparator<Team> orderByComparator) {
	 ...
	 */
	@Override
	public Team[] findByName_PrevAndNext(long teamId, String name,
		OrderByComparator<Team> orderByComparator) throws NoSuchTeamException {
		Team team = findByPrimaryKey(teamId);
		...
		try {
			...
			array[0] = getByName_PrevAndNext(session, team, name,
					orderByComparator, true);

			array[1] = team;

			array[2] = getByName_PrevAndNext(session, team, name,
					orderByComparator, false);
	...
	protected Team getByName_PrevAndNext(Session session, Team team,
		String name, OrderByComparator<Team> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByName(String name) {
		for (Team team : findByName(name, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
				null)) {
			remove(team);
		}
	}
	...
	private static final String _FINDER_COLUMN_NAME_NAME_1 = "team.name IS NULL";
	private static final String _FINDER_COLUMN_NAME_NAME_2 = "team.name = ?";
	private static final String _FINDER_COLUMN_NAME_NAME_3 = "(team.name IS NULL OR team.name = '')";
	...
	protected Team toUnwrappedModel(Team team) {
		...
		teamImpl.setGrpId(team.getGrpId());
