...
/**
 * The base model interface for the Team service. Represents a row in the &quot;WorldCup_Team&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.objective.worldcup.model.impl.TeamModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.objective.worldcup.model.impl.TeamImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface TeamModel extends BaseModel<Team>, GroupedModel, ShardedModel,
	StagedAuditedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
