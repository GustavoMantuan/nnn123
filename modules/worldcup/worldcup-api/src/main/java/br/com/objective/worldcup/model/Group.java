 ...
 * @see GroupModel
 * @see br.com.objective.worldcup.model.impl.GroupImpl
 * @see br.com.objective.worldcup.model.impl.GroupModelImpl
 * @generated
 */
@ImplementationClassName("br.com.objective.worldcup.model.impl.GroupImpl")
@ProviderType
public interface Group extends GroupModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link br.com.objective.worldcup.model.impl.GroupImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
